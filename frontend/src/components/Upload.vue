<template>
  <div class="container">
    ...
    <!-- <p style="margin-top: 20px; text-align: center; font-size: 14px; padding: 0; margin: 0">
      <a href="https://qkongtao.cn/" target="_blank" style="text-decoration: none; color: #409eff">Nickの个人小站</a>
    </p>
    <div style="height: 45px; line-height: 45px; text-align: center; font-size: 14px">
      本网站由
      <a href="https://www.upyun.com/?utm_source=lianmeng&utm_medium=referral" target="_blank">
        <img
          src="http://qncdn.qkongtao.cn/kodbox/202208/24_dc662e30/%E5%8F%88%E6%8B%8D%E4%BA%91_logo2.png"
          style="width: 80px; vertical-align: middle; display: inline" /></a
      >提供CDN加速/云存储服务
    </div> -->
  </div>
</template>
...
export default {
  data() {
    return {
      options: {
        // 上传地址
        target: 'http://localhost:9090/api/upload',
  ...
  //       encodeURI('https://qiniu.qkongtao.cn/2022/08/20220829082301689.pptx')
  //   )
  // },
  methods: {
