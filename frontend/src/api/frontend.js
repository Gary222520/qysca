...
// 查看应用的许可证冲突信息
export const GetLicenseConflict = (params) => request('get', API.APP_LICENSE_CONFLICT, { params })
// 查看组件的许可证冲突信息
export const GetComLicenseConflict = (params) => request('get', API.COM_LICENSE_CONFLICT, { params })
