...
@Builder
@Entity
@Table(name= "plt_visited_npm_packages", uniqueConstraints = @UniqueConstraint(columnNames = {"name", "version"}))
public class NpmVisitedPackagesDO {
    @Id
    ...
    @ApiModelProperty(value = "包名称", example = "@clyan/eslint-config")
    private String name;
