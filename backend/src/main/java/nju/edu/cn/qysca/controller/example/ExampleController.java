...
public class ExampleController {
    ...
    public ResponseMsg<ExampleDTO> addOne(@RequestBody ExampleDTO exampleDTO) {
        return new ResponseMsg<>(exampleService.addOne(exampleDTO));
    }
    ...
    public ResponseMsg<ExampleDTO> updateOne(@RequestBody ExampleDTO exampleDTO) {
        return new ResponseMsg<>(exampleService.updateOne(exampleDTO));
    }


    @GetMapping("/findAll")
    @ApiOperation(value = "查询所有记录")
    public ResponseMsg<List<ExampleDTO>> findAll() {
    ...
    public ResponseMsg<List<ExampleDTO>> findByInfo(@ApiParam(value = "信息", required = true) @RequestParam String info) {
    ...
    public ResponseMsg<List<ExampleDTO>> findByRule(@ApiParam(value = "特定字符串", required = true) @RequestParam String string) {
