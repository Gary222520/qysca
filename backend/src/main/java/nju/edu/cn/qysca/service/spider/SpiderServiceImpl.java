...
public class SpiderServiceImpl implements SpiderService {
    ...
    public ComponentDO crawlByGav(String groupId, String artifactId, String version) {
        ...
        ComponentDO javaOpenComponentDO = crawl(pomUrl);
    ...
    private ComponentDO crawl(String pomUrl) {
        ...
        ComponentDO javaOpenComponentDO = convertToJavaOpenComponentDO(document, pomUrl, MAVEN_REPO_BASE_URL);

        return javaOpenComponentDO;
    }

    public ComponentDO convertToJavaOpenComponentDO(Document document, String pomUrl, String MAVEN_REPO_BASE_URL) {
        ...
        ComponentDO javaOpenComponentDO = new ComponentDO();
        ...
        javaOpenComponentDO.setOpensource(true);
