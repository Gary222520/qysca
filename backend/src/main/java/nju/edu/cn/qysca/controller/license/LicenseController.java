...
public class LicenseController {
    ...
    @PreAuthorize("@my.checkAuth('/qysca/license/getAppLicense')")
    ...
    @PreAuthorize("@my.checkAuth('/qysca/license/getComponentLicense')")
    ...
    @PreAuthorize("@my.checkAuth('/qysca/license/addAppLicense')")
    ...
    @PreAuthorize("@my.checkAuth('/qysca/license/deleteAppLicense')")
    ...
    @PreAuthorize("@my.checkAuth('/qysca/license/getLicenseInfo')")
    ...
    @PreAuthorize("@my.checkAuth('/qysca/license/getLicensePage')")
    ...
    @PreAuthorize("@my.checkAuth('/qysca/license/getAppLicenseConflict')")
    ...
    @PreAuthorize("@my.checkAuth('/qysca/license/getComponentLicenseConflict')")
